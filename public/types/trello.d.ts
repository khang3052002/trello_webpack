...
export namespace Trello {
  ...
  export namespace Callback {
    ...
    export interface Cache {
      ...
      serialize(
        fx: (t: PowerUp.IFrame, args: unknown) => unknown
      ): SerializeOutput;
  ...
  export namespace PowerUp {
    ...
    export type CapabilityHandlers = {
      ...
      "list-actions"?: (
        t: PowerUp.IFrame
      ) => PromiseLike<ListAction[]> | ListAction[];
      "list-sorters"?: (
        t: PowerUp.IFrame
      ) => PromiseLike<ListSorter[]> | ListSorter[];
      ...
      "authorization-status"?: (
        t: PowerUp.IFrame,
        options: unknown
      ) => PromiseLike<AuthorizationStatusResponse>;
